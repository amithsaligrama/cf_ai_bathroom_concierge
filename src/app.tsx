...
function Chat() {
  ...
  const handleClear = useCallback(async () => {
    try {
      await agent.call("resetPreferences", []);
    } catch (error) {
    ...
    >
          ...
          <div className="flex items-center gap-3 min-w-0">
            <div className="min-w-0">
              <h1 className="text-lg font-semibold text-kumo-default truncate">
                <span className="mr-2">🚻</span>Bathroom Access Concierge
              </h1>
              <Text size="xs" variant="secondary">
                Accessible restroom recommendations in chat
              </Text>
            </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto px-5 py-8 space-y-6">
          {messages.length === 0 && (
            <Surface className="rounded-2xl border border-kumo-line bg-kumo-base/80 px-5 py-6">
              <Empty
                icon={<ChatCircleDotsIcon size={32} />}
                title="Find a suitable restroom"
                contents={
                  <div className="space-y-4">
                    <Text size="sm" variant="secondary">
                      Tell me where you are and what matters most, and I will
                      recommend options with clear reasoning.
                    </Text>
                    <div className="flex flex-wrap justify-center gap-2.5">
                      {[
                        "Find me a nearby wheelchair-accessible restroom.",
                        "Please remember that I prefer single-stall restrooms.",
                        "I need an open restroom with a changing table.",
                        "Show me options near downtown Boston."
                      ].map((prompt) => (
                        <Button
                          key={prompt}
                          variant="outline"
        ...
        >
          ...
          <div className="flex items-end gap-3 rounded-xl border border-kumo-line bg-kumo-base p-3 shadow-sm focus-within:ring-2 focus-within:ring-kumo-ring focus-within:border-transparent transition-shadow">
            ...
            <InputArea
              ...
              placeholder={
                attachments.length > 0
                  ? "Bathroom Access Concierge: add details or send images..."
